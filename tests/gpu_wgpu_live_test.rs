...
use cml::gpu_wgpu_runtime::{AdapterPolicy, execute_map_blocking_with_policy};
...
fn admitted_i32_map_executes_on_live_adapter() {
    ...
    let execution = execute_map_blocking_with_policy(&ir, AdapterPolicy::AnyComputeAdapter)
        .expect("live wgpu execution failed");
